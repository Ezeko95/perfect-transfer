  ...
  return (
    <div className="relative h-screen overflow-hidden">
      ...
      <div className="flex flex-col z-10 relative h-full justify-center items-center gap-y-52 sm:gap-y-10 md:gap-y-16 lg:gap-y-48">
        <div className="mb-8 mt-8 p-3 max-w-5xl bg-white bg-opacity-20 shadow-2xl py-8 relative backdrop-blur sm:p-2 md:p-2 sm:max-w-xl md:max-w-xl lg:max-w-5xl">
          <h1 className="text-5xl text-white font-tinos italic text-center z-10 sm:text-2xl md:text-2xl lg:text-5xl">

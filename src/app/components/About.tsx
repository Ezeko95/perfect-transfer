  ...
  return (
    <div className="font-garamond" id="about" ref={sectionRef1}>
      <div className="flex flex-row items-center justify-center px-36 py-12">
        <div className="">
          <h2 className="text-4xl font-garamond font-light italic text-white py-4 px-6 rounded-t-sm max-w-sm bg-black">
            Misión
          </h2>
      ...
      <div className="flex flex-row items-center justify-center px-36 py-12 gap-x-20">
        <div className="">
          ...
          <ol className="text-xl font-light max-w-7xl pt-8 text-blacklist-disc">
            <li>
            ...
            <li>
              ...
              Brindar un servicio personalizado, ágil y confiable que supere las
            ...
            <li>
              ...
              innovadores y soluciones creativas para la impresión gráfica.
            </li>
            <li>
              <span className="underline font-bold text-2xl">
      ...
      <div className="flex flex-row-reverse justify-center items-center px-36 py-5 gap-x-20">
        <div className="">
          ...
          <ol className="text-black font-garamond text-xl py-8 max-w-6xl  list-disc rounded-b-sm rounded-l-sm">
            <li>
              <span className="underline font-bold text-2xl">Calidad:</span>{" "}
              Comprometidos con la excelencia en la calidad de nuestros
              productos y servicios.
            </li>
            <li>
              <span className="underline font-bold text-2xl">Integridad:</span>{" "}
              Actuar con honestidad, transparencia y ética en todas nuestras
              operaciones.
            </li>
            <li>
              <span className="underline font-bold text-2xl">Innovación:</span>{" "}
